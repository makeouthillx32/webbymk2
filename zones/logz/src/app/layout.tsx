// zones/logz/src/app/layout.tsx
// Root layout for the logz zone (logz.unenter.live).
...
export const metadata: Metadata = {
  title: {
    default: "Logz | Unenter",
    template: "%s | Logz – Unenter",
  },
  description: "Welcome to the Logz zone.",
};
