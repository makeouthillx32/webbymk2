...
//   • <ClientLayout>  — the shop header + footer selected in the wizard,
...
//
// You can keep this file as-is; anything you build under  src/zones/labs/
...
// NOTE: body font is intentionally NOT hardcoded via next/font here.
// The active theme (default / vintage / sharp / monochrome) sets --font-sans
// dynamically at runtime (see app/providers/ThemeProvider.tsx), and the
// `font-sans` Tailwind utility below resolves to that CSS variable
// (tailwind.config.ts: sans: ['var(--font-sans)', ...]). Hardcoding a
// next/font here would silently override every theme's typography.
