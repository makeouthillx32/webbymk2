// zones/yayy/src/app/layout.tsx
// Root layout for the yayy zone (yayy.unenter.live).
...
export const metadata: Metadata = {
  title: {
    default: "Yayy | Unenter",
    template: "%s | Yayy – Unenter",
  },
  description: "Welcome to the Yayy zone.",
};
