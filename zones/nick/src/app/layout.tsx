// zones/nick/src/app/layout.tsx
// Root layout for the nick zone (nick.unenter.live).
...
export const metadata: Metadata = {
  title: {
    default: "Nick | Unenter",
    template: "%s | Nick – Unenter",
  },
  description: "Welcome to the Nick zone.",
};
