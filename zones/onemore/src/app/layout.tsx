// zones/onemore/src/app/layout.tsx
// Root layout for the onemore zone (onemore.unenter.live).
...
export const metadata: Metadata = {
  title: {
    default: "Onemore | Unenter",
    template: "%s | Onemore – Unenter",
  },
  description: "Welcome to the Onemore zone.",
};
