// zones/running/src/app/layout.tsx
// Root layout for the running zone (running.unenter.live).
...
export const metadata: Metadata = {
  title: {
    default: "Running | Unenter",
    template: "%s | Running – Unenter",
  },
  description: "Welcome to the Running zone.",
};
