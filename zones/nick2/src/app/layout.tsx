// zones/nick2/src/app/layout.tsx
// Root layout for the nick2 zone (nick2.unenter.live).
...
export const metadata: Metadata = {
  title: {
    default: "Nick2 | Unenter",
    template: "%s | Nick2 – Unenter",
  },
  description: "Welcome to the Nick2 zone.",
};
