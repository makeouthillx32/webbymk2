// zones/apptest1/src/app/layout.tsx
// Root layout for the apptest1 zone (apptest1.unenter.live).
...
export const metadata: Metadata = {
  title: {
    default:  "Apptest1 | Unenter",
    template: "%s | Apptest1 – Unenter",
  },
  description: "Welcome to the Apptest1 zone.",
};
