 ...
 * Generates a well-documented template file for Unaxis keybindings.
 */
...
export function generateKeybindingsTemplate(): string {
  ...
  const config = {
    $schema: 'https://unaxis.local/schemas/keybindings.json',
    $docs: 'https://unaxis.local/docs/keybindings',
    bindings,
  }
