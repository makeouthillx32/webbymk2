...
export default function Hero3() {
  ...
  return (
    ...
    >
      <div className="hero7-container text-center flex justify-center items-center gap-8 max-w-4xl mx-auto">
        {/* GIF 1 */}
        <div className="gif-wrapper flex flex-col items-center text-center">
          <img
            src="/images/Hero7gif1.gif"
            alt="Creative Design 1"
            className="gif1 hover:scale-110 transition-transform duration-300 w-[150px] h-[150px]"
          />
          <div
            className="hero7-caption font-bold mt-2 text-2xl dark:text-white text-black"
        ...
        <div className="hero7-text text-2xl mx-6 flex justify-center items-center text-black dark:text-white">
        ...
        <div className="gif-wrapper flex flex-col items-center text-center">
          <img
            ...
            className="gif2 hover:scale-110 transition-transform duration-300 w-[150px] h-[150px]"
