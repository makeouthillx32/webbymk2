...
export type Theme = {
  ...
  bashBorder: string
  unaxis: string
  unaxisShimmer: string // Lighter version of Unaxis color for shimmer effect
  unaxisBlue_FOR_SYSTEM_SPINNER: string
  unaxisBlueShimmer_FOR_SYSTEM_SPINNER: string
  permission: string
  ...
  chromeYellow: string
  // TUI V2 colors
  unaxis_mark_body: string
  unaxis_mark_background: string
...
const lightTheme: Theme = {
  ...
  unaxis: 'rgb(215,119,87)', // Unaxis brand accent
  unaxisShimmer: 'rgb(245,149,117)', // Lighter Unaxis brand accent for shimmer effect
  unaxisBlue_FOR_SYSTEM_SPINNER: 'rgb(87,105,247)', // Medium blue for system spinner
  unaxisBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(117,135,255)', // Lighter blue for system spinner shimmer
  ...
  // TUI V2 colors
  unaxis_mark_body: 'rgb(215,119,87)',
  unaxis_mark_background: 'rgb(0,0,0)',
  ...
  briefLabelUnaxis: 'rgb(215,119,87)', // Brand orange
...
const lightAnsiTheme: Theme = {
  ...
  unaxis: 'ansi:redBright',
  unaxisShimmer: 'ansi:yellowBright',
  unaxisBlue_FOR_SYSTEM_SPINNER: 'ansi:blue',
  unaxisBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  ...
  // TUI V2 colors
  unaxis_mark_body: 'ansi:redBright',
  unaxis_mark_background: 'ansi:black',
  ...
  briefLabelUnaxis: 'ansi:redBright',
...
const darkAnsiTheme: Theme = {
  ...
  unaxis: 'ansi:redBright',
  unaxisShimmer: 'ansi:yellowBright',
  unaxisBlue_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  unaxisBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const lightDaltonizedTheme: Theme = {
  ...
  unaxis: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  unaxisShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  unaxisBlue_FOR_SYSTEM_SPINNER: 'rgb(51,102,255)', // Bright blue for system spinner
  unaxisBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(101,152,255)', // Lighter bright blue for system spinner shimmer
  ...
  fastModeShimmer: 'rgb(255,150,50)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelUnaxis: 'rgb(255,153,51)', // Orange adjusted for deuteranopia (matches Unaxis)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkTheme: Theme = {
  ...
  unaxis: 'rgb(215,119,87)', // Unaxis brand accent
  unaxisShimmer: 'rgb(235,159,127)', // Lighter Unaxis brand accent for shimmer effect
  unaxisBlue_FOR_SYSTEM_SPINNER: 'rgb(147,165,255)', // Blue for system spinner
  unaxisBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(177,195,255)', // Lighter blue for system spinner shimmer
...
const darkDaltonizedTheme: Theme = {
  ...
  unaxis: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  unaxisShimmer: 'rgb(255,183,101)', // Lighter orange for shimmer effect
  unaxisBlue_FOR_SYSTEM_SPINNER: 'rgb(153,204,255)', // Light blue for system spinner
  unaxisBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(183,224,255)', // Lighter blue for system spinner shimmer
