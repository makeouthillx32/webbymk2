 ...
 *
 * Transitions:
 *   idle to dispatching  (reserve)
 *   dispatching to running  (tryStart)
 *   idle to running  (tryStart, for direct user submissions)
 *   running to idle  (end / forceEnd)
 *   dispatching to idle  (cancelReservation, when processQueueIfReady fails)
 *
...
export class QueryGuard {
  ...
  /**
   * Reserve the guard for queue processing. Transitions idle to dispatching.
   ...
   * Transitions dispatching to idle.
   */
