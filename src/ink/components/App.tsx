...
export default class App extends PureComponent<Props, State> {
  ...
  handleSuspend = (): void => {
    ...
    // Emit suspend event for UNENTER Code to handle. Mostly just has a notification
    ...
    const resumeHandler = () => {
      ...
      if (this.props.stdout.isTTY) {
        if (!isEnvTruthy(process.env.UNT_TERM_ACCESSIBILITY)) {
          this.props.stdout.write(HIDE_CURSOR);
        }
      ...
      // Emit resume event for UNENTER Code to handle
