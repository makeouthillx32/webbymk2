...
type Props = {
  ...
  /** Whether to enable automatic terminal theme detection. Defaults to true. */
...
export function ThemeProvider({
  ...
  useEffect(() => {
    if (enableAutoTheme) {
      ...
      // Dynamic import to keep the watcher logic decouple/lazy
      void import('../../utils/systemThemeWatcher.js').then(
        ...
        console.error('Failed to load systemThemeWatcher:', err);
      });
  ...
  }, [activeSetting, internal_querier, enableAutoTheme]);
