...
// zone is controlled by the NEXT_PUBLIC_ZONE="__ZONE_KEY__" override in
...
export const metadata: Metadata = {
  title:       "__ZONE_LABEL__ | Unenter",
  description: "__ZONE_LABEL__ — __ZONE_DOMAIN__",
};
