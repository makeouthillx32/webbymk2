...
// Layout: landing  (LandingHeader + LandingFooter)
//
// This zone page fetches landing_sections from Supabase and renders each row
// through SectionComponents — the same pattern as the core home page.
//
...
//
// Add rows with page = "__ZONE_KEY__" to the landing_sections table to
// populate the page.  The fallback hero below is shown while it is empty.
//
