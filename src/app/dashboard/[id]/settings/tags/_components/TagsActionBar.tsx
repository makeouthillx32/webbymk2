// app/settings/tags/_components/TagsActionBar.tsx
"use client";
...
export function TagsActionBar({ search, onSearchChange, onCreate }: Props) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="w-full sm:max-w-sm">
        <TagsSearchBar value={search} onChange={onSearchChange} />
      </div>
