// app/api/research-products/admin/[id]/categories/route.ts
...
/**
 * POST /api/research-products/admin/[id]/categories
...
/**
 * DELETE /api/research-products/admin/[id]/categories?category_id=uuid
 */
