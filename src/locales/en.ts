export default {
  ...
  kick: {
    title: "UNENTER",
    description:
      "I will let you witness my coding skills in real time and leave you inspired and in awe. Uncut and RAW, I'm taming the software with sheer manliness. Follow me if you're willing to expose yourself to high amounts of alpha particles.",
    streamButton: "Watch me on KICK.com",
    didYouKnowTitle: "Did you know...",
    didYouKnowItems: [
      "You can type a color in chat to change the stream color.",
      "Subscribe to have my receipt printer print your profile pic.",
      "You can use chat commands to interact.",
      "Show off your badges and trophies on stream.",
      "Click here to learn more.",
    ],
  },

  // Hero2 section, separate from kick
  hero2: {
    title: "Join Our Discord",
    paragraph:
      "Be part of an amazing community on Discord! Interact with real-time content, join exclusive discussions, and enjoy special member perks.",
    button: "Join the Community",
    extraTitle: "Why Join Us?",
    extraPoint1: "Exclusive Discord events and streams.",
    extraPoint2: "Access to real-time updates and content drops.",
    extraPoint3: "Special roles and perks for active members.",
    extraPoint4: "Interact with community members and have fun!",
  },
  ...
  about: {
    ...
    description:
      " 'Win Through Your Actions, Never Through Argument: Demonstrate your point rather than arguing. Arguing rarely changes anyone’s mind, but people believe what they see. They’re also less likely to be offended.' ",
  },
